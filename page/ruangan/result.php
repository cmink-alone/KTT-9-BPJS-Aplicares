...
$tsd=0;
    ...
    //untuk create 
	$url = $host."/aplicaresws/rest/bed/create/".$u;
	//echo $url;
	//untuk update
    ...
    if($feedback=='1'){
      ...
      $query1=mysql_query("INSERT INTO datruang(idruang,kodekelas,koderuang,namaruang,kapasitas,tersedia,tglentri,kdppk) 
      VALUES('$idr','$kls','$kdr','$nmr','$kap','$tsd','$tgl','$u')");
  	...
  	<div class="col-md-6">
  		<div class="alert alert-dismissible alert-success">
            <button type="button" class="close" data-dismiss="alert">&times;</button>
                Ruangan dengan nama <?php echo $nmr ;?> <?php echo $nm_kelas; ?> Telah Berhasil dientri
        </div>
    </div>
  <?php } elseif($feedback=='0'){ ?>
 	<div class="col-md-6">
  		<div class="alert alert-dismissible alert-danger">
            <button type="button" class="close" data-dismiss="alert">&times;</button>
                Ruangan dengan nama <?php echo $nmr ;?> <?php echo $nm_kelas; ?> Telah Ada di Database
        </div>
    </div>
  <?php } if ($koneksi=='0'){ ?>
  <div class="col-md-6">
